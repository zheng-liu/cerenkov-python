...
hyperparameter_gwava_xgb1 = dict(
    learning_rate=0.1,
    n_estimators=30,
    gamma=10,
    subsample=1,
...
hyperparameter_osu = [hyperparameter_osu1, hyperparameter_osu2]
hyperparameter_gwava_rf = [hyperparameter_gwava_rf1]
hyperparameter_gwava_xgb = [hyperparameter_gwava_xgb1]
...
#         result_list_unparallel.append(method_list[i](dataset_list[i], hyperparameter_list[i], fold, "LOCUS"))
# end_time = time.time()
