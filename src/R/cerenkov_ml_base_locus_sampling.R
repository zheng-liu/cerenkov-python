...
g_make_temp_dir_if_doesnt_exist <- function(...) {
    temp_directory <- g_temp_directory()
...
g_make_make_custom_xgboost_objective_avgrank <- function(p_global_case_group_ids,
    ...
    g_custom_objective_function_avgrank_cxx <- g_make_cxx_function_with_lazy_compile(cxx_code_avgrank,
                                                                                     p_func_get_temp_directory)
    ...
    function(p_train_case_ids, p_custom_objective_function_parameters_list) {
        ...
        function(preds, dtrain) {
            ...
            ret_list_cxx <- g_custom_objective_function_avgrank_cxx(preds,
                                                                    labels,
            ...
            if (! is.null(p_custom_objective_function_parameters_list$debug) &&
                ...
                ret_list_R <- g_custom_objective_function_avgrank(preds,
                                                                  labels,
                                                                  group_to_case_ids_map_list,
                                                                  case_group_ids,
                                                                  bandwidth)
...
g_verify_that_singleton_groups_are_all_positive_cases <- function(p_labels,
